...
const GROUPS: NavGroup[] = [
  ...
  { label: 'Marketplace', items: [{ id: 'skills', label: 'Skills', to: '/skills', icon: navIcons.skills }] },
  {
    ...
    items: [
      ...
      { id: 'cat', label: 'Catalog Sources', to: '/platform/catalogs', icon: navIcons.cat, adminOnly: true },
      { id: 'ducklake', label: 'DuckLake', to: '/platform/ducklake', icon: navIcons.ducklake, adminOnly: true },
